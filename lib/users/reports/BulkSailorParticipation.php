...
/**
 * Generates list of events participated for given sailor IDs.
 *
 * Useful as part of the All-American selection process.
 *
 * @author Dayan Paez
 * @version 2018-08-06
 * @see CompareHeadToHead
 */
class BulkSailorParticipation extends AbstractReportPane {
  /**
   * Creates a new pane
   */
  public function __construct(Account $user) {
    parent::__construct("Sailor participation report", $user);
  }

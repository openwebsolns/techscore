 ...
 *
 * Based off RpEnterPane, this version enforces the attendee
 * separation, but provides a more shocking transition for the end
 * user.
 *
 * @author Dayan Paez
 * @version 2015-03-18
 */
class RpAttendeePane extends AbstractPane {
